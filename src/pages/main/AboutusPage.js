...
const AboutUsPage = () => {
  ...
  <div className={styles.pageContainer}>
    ...
    <img className={styles.bgImg} src="/images/intro/bg-img.png" alt="bg-img" />
  <div className="inner">
    <section className={styles.section1}>
      <h1>여행을 더욱 편리하게, 당신의 지출을 완벽하게 관리하세요!</h1>
      <h2>"Travility"</h2>
      <p>Travel & Facility의 합성어로, 여행을 더욱 편리하게 만들어드리는 어플입니다.</p>
    ...
    <section className={styles.section5}>
      ...
      <p className={styles.detail}>내 여행 기록과 일자별 소비 내역까지 한 번에 볼 수 있어요.</p>
