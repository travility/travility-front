...
import styles from "../../../styles/accountbook/detail/AddExpense.module.css";
            ...
            <div className={styles.modal_content}>
              ...
              <div className="error_container">
                {(errors.title || titleError) && (
                  <ErrorMessage>{errors.title || titleError}</ErrorMessage>
                )}
                <span className={styles.addExpense_title_count}>
                  {inputCount}/20 자
                </span>
              </div>
                ...
                <div className={styles.addExpense_formGroup}>
                  <div className={styles.curUnit_input}>
                    ...
                    <Select
                      id="curUnit"
                      name="curUnit"
                      className={styles.curUnit_select}
                      value={{
